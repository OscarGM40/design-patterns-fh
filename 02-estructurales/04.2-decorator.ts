...
function main() {
  ...
  console.log("\n\n");
  //! Fijate que en cualquier momento puedo pasar el personaje básico para resetear las stats, asinto!!! Envidias toxic
  //TODO montar todo esto de nuevo otro día, recuerda que el patrón decorador permite extender un objeto en tiempo de ejecución
}
